...
/// Returns the PID of the foreground process controlling the surface's PTY,
/// or 0 if unavailable. Uses tcgetpgrp() internally (O(1) kernel call).
uint32_t ghostty_surface_foreground_pid(ghostty_surface_t);
